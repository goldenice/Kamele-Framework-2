...
class QueryBuilderMssqlTest extends PHPUnit_Framework_Testcase {
    ...
    public function setUp() {
        ...
        require_once 'system/database/drivers/mssql/querybuilder.php';
        
        $this->qb1 = new \System\Database\Drivers\Mssql\QueryBuilder(null);
        $this->qb2 = new \System\Database\Drivers\Mssql\QueryBuilder(null);
        $this->qb3 = new \System\Database\Drivers\Mssql\QueryBuilder(null);
        $this->qb4 = new \System\Database\Drivers\Mssql\QueryBuilder(null);
    }
